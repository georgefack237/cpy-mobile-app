...
import '../../hymns/pages/widgets/poem_item.dart';


class LocalPoemsPage extends StatefulWidget {
  const LocalPoemsPage({super.key, required this.hymnBook});

  final HymnBookCollection hymnBook;

  @override
  State<LocalPoemsPage> createState() => _LocalPoemsPageState();
}

class _LocalPoemsPageState extends State<LocalPoemsPage> {
  ...
  void initState() {
    ...
    provider.getLocalHymnBookPoems(hymnBookId: widget.hymnBook.id);
    super.initState();
  }
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            centerTitle: false,
            title: Text(
              widget.hymnBook.nameFr.toString(),
      ...
      Consumer<LocalHymnBookProvider>(builder: (context, provider, child) {
        ...
        return provider.poems != null ? Column(
          children: [
                  ...
                  return InkWell(
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        selectedPoems = provider.poems!.where((poem){return poem.poemCategoryId == selected!.id;}).toList();
                      });
                    },
                    child: Container(
            ...
            ): selected!.id != 0 && selectedPoems.isNotEmpty? Expanded(
              child: ListView.builder(
                  padding: const EdgeInsets.only(left: 0, right: 0),
            ...
            ): selected!.id != 0 && selectedPoems.isEmpty ? Container(
