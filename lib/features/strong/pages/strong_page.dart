...
class _StrongPageState extends State<StrongPage> with AutomaticKeepAliveClientMixin {
  ...
  filterWords({required String query, required List<WordReference> words}) {
  ...
  Widget buildOfflineContent(WordReferenceProvider homeProvider) {
    return Consumer<WordReferenceProvider>(
        builder: (context, provider, child) {
          ...
          return provider.localWords != null ? Column(
            children: [
          ...
          provider.isLoading ? const Expanded(
  ...
  Widget buildContent() {
    return Consumer<WordReferenceProvider>(
        builder: (context, provider, child) {
          ...
          return provider.words != null ? Column(
            children: [
